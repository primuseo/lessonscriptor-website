    ...
    <article className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-lg max-w-none space-y-8 text-gray-800 leading-relaxed">
        ...
        <section>
          ...
          <p>
            Lessonscriptor is a Chrome extension developed and operated by Pierre Girardot. We are committed to protecting your privacy and respecting the European General Data Protection Regulation (GDPR) and other applicable privacy laws. For any privacy-related questions, you can contact us at <a href="mailto:contact@lessonscriptor.com" className="text-blue-600 hover:underline">contact@lessonscriptor.com</a>.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            <strong>Grok API (xAI):</strong> Premium mode users have the option to use Grok (xAI) for high-accuracy transcription. Audio is sent to the Grok API, processed, and immediately deleted. Please review <a href="https://grok.x.ai/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">xAI's privacy policy</a> for details on how they handle data.
          </p>
          <p>
        ...
        <section>
          ...
          <p className="mt-4">
            <strong>Important note:</strong> Since Lessonscriptor does not collect personal data on our servers, most of these rights are moot for data processed by us. Your transcripts exist only in your browser's local storage, which you control directly. If you have questions about your rights, please contact us at <a href="mailto:contact@lessonscriptor.com" className="text-blue-600 hover:underline">contact@lessonscriptor.com</a>.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-4 font-semibold">
            Lessonscriptor<br />
            Email: <a href="mailto:contact@lessonscriptor.com" className="text-blue-600 hover:underline">contact@lessonscriptor.com</a>
          </p>
        </section>
      ...
      {/* Note about language */}
      <div className="mt-12 pt-8 border-t border-gray-200 text-sm text-gray-600 italic">
        <p>
