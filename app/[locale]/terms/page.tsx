  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-lg max-w-none space-y-8 text-gray-800 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Free Mode</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Premium Mode — Pay-as-You-Go</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">5. License and Intellectual Property</h2>
          <p>
            Lessonscriptor is distributed under the MIT License with a non-commercial clause.
          </p>
          <ul className="list-disc list-inside space-y-2 ml-2">
        ...
        <section>
          ...
          <p>
            Your use of Lessonscriptor is also governed by our <a href={`https://lessonscriptor.com${base}/privacy`} className="text-blue-600 hover:underline">Privacy Policy</a>. Please review it to understand our privacy practices.
          </p>
        </section>
